...
// if want use Arrays, must import this library
import java.util.Arrays;
import java.util.Scanner;

public class zyBook_6_1 {
    /*
      * Definition of array: A collection of values of the same type stored in contiguous memory locations,
      * each of which can be accessed by an integer index.
      * Definition of reference: A value that denotes the location of an object or array in memory
     */
