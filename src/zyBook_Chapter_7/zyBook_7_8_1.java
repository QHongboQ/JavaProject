...
/*
* command line: ava Search -min 90 -d grades.txt
* passe this command line to public static void main(String[] args)
* The statement is Search, arguments are '-min', '90', '-d', 'grades.txt'
* */